   ...
   next(null, './public/randomGame1/photo-storage');
    ...
    filename: function(req, file, next){
        ...
        next(null, x);
    		...
    		fs.writeFile('FILE.json', data, dummy);
 ...
 destination: function(req, file, next){
   next(null, './public/randomGame2/photo-storage2');
    ...
    filename: function(req, file, next){
        ...
        fs.writeFile('FILE2.json', data2, dummy);
 ...
 destination: function(req, file, next){
   next(null, './public/randomGame3/photo-storage3');
    ...
    filename: function(req, file, next){
        ...
        fs.writeFile('FILE3.json', data3, dummy);
 ...
 destination: function(req, file, next){
   next(null, './public/randomGame4/photo-storage4');
    ...
    filename: function(req, file, next){
        ...
        fs.writeFile('FILE4.json', data4, dummy);
 ...
 destination: function(req, file, next){
   next(null, './public/randomGame5/photo-storage5');
    ...
    filename: function(req, file, next){
        ...
        fs.writeFile('FILE5.json', data5, dummy);
...
app.post("/eliminar3",(request,response)=> {
  ...
  for(let i=0;i<FilesLength;i++){
    if(files3[i]==lol){
      files3[i]="borrado";
      let data3 = JSON.stringify(files3, null, 2);
      fs.writeFile('FILE.json', data3, dummy);
...
app.post("/eliminar4",(request,response)=> {
  ...
  for(let i=0;i<FilesLength;i++){
    if(files4[i]==lol){
      files4[i]="borrado";
      let data4 = JSON.stringify(files4, null, 2);
      fs.writeFile('FILE.json', data4, dummy);
...
app.post("/eliminar5",(request,response)=> {
  ...
  for(let i=0;i<FilesLength;i++){
    if(files5[i]==lol){
      files5[i]="borrado";
      let data5 = JSON.stringify(files5, null, 2);
      fs.writeFile('FILE.json', data5, dummy);
